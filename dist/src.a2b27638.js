...
var Cl_pasajero = /*#__PURE__*/function () {
  function Cl_pasajero(nombre, tipo, feriado, carnet) {
    _classCallCheck(this, Cl_pasajero);
    this.nombre = nombre;
    this.tipo = tipo;
    this.feriado = feriado;
    this.carnet = carnet;
  }
  _createClass(Cl_pasajero, [{
    key: "paga",
    value: function paga() {
      var precioBase = 1000,
...
var Cl_ruta = /*#__PURE__*/function () {
  function Cl_ruta() {
    _classCallCheck(this, Cl_ruta);
    this.acumPago = this.contPasajeros = 0;
  }
  _createClass(Cl_ruta, [{
    key: "procesarPasajero",
    value: function procesarPasajero(p) {
      this.contPasajeros++;
      this.acumPago += p.paga();
    }
  }, {
    key: "totalCobrado",
    value: function totalCobrado() {
      return this.acumPago;
    }
  }, {
    key: "precioPromedio",
    value: function precioPromedio() {
...
salida.innerHTML += "<br>".concat(pasajero1.nombre, " paga: ").concat(pasajero1.paga());
salida.innerHTML += "<br>".concat(pasajero2.nombre, " paga: ").concat(pasajero2.paga());
salida.innerHTML += "<br>".concat(pasajero3.nombre, " paga: ").concat(pasajero3.paga());
salida.innerHTML += "<br>".concat(pasajero4.nombre, " paga: ").concat(pasajero4.paga());
